...
public class BorrowBookFrame extends JFrame {
	...
	public BorrowBookFrame(BorrowBookController controller) {
		super();
		...
		toolBar.add(new AbstractAction("Save") {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					getController().save();
					JOptionPane.showMessageDialog(BorrowBookFrame.this,
							"Record Saved");
				} catch (Exception ee) {
					ee.printStackTrace();
					JOptionPane.showMessageDialog(BorrowBookFrame.this, ee
		...
		headerPanel.add(new JLabel("From Site"));
		...
		findButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FindBorrowerController fbc = new FindBorrowerController(
						new FindBorrowerDialog(BorrowBookFrame.this));
	...
	public BorrowBookController getController() {
		return controller;
	}

	public void setController(BorrowBookController controller) {

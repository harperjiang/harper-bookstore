...
public class MonitorStockJobTest {
	...
	@Test
	public void testSiteThresholdParamEntry() {
	...
	@Test
	public void testGlobalThresholdParamEntry() {
		MemoryCommonRepo mcr = new MemoryCommonRepo();
		MemoryStoreRepo msr = new MemoryStoreRepo();
		msr.setCommonRepo(mcr);
		MemoryTodoRepo mtr = new MemoryTodoRepo();
	...
	@Test
	public void testSiteThresholdParamAlert() {
		MemoryCommonRepo mcr = new MemoryCommonRepo();
		MemoryStoreRepo msr = new MemoryStoreRepo();
		msr.setCommonRepo(mcr);
		MemoryTodoRepo mtr = new MemoryTodoRepo();
		...
		job.setTriggerEvent(new MediatorEvent(sasite));
	...
	@Test
	public void testGlobalThresholdParamAlert() {
		MemoryCommonRepo mcr = new MemoryCommonRepo();
		MemoryStoreRepo msr = new MemoryStoreRepo();
		msr.setCommonRepo(mcr);
		MemoryTodoRepo mtr = new MemoryTodoRepo();

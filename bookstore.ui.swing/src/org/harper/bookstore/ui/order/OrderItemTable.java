 ...
 * 
 */
public class OrderItemTable extends JPanel {
	...
	public OrderItemTable() {
		...
		tableModel.initialize(OrderItemTableData.class);
		tableModel.setCellEditable(2, true);
		tableModel.setCellEditable(3, true);
		...
		controller = new OrderItemController(this, null);
		...
		isbnTextField.setCallback(new Callback() {
			...
			public void exception(Exception e) {
				JOptionPane.showMessageDialog(OrderItemTable.this, e
	...
	protected void postProcessItem(OrderItem item, boolean isNew) {

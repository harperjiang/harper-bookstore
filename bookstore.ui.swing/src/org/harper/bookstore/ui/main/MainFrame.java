...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		orderToolBar.add(new ControllerAction(Messages.getString("MainFrame.create_purchase_order"), //$NON-NLS-1$
				POController.class));
		orderToolBar.add(new ControllerAction(Messages.getString("MainFrame.create_supply_order"), //$NON-NLS-1$
				SOController.class));
		orderToolBar.add(new ControllerAction(Messages.getString("MainFrame.query_orders"), //$NON-NLS-1$
				ViewOrderController.class));
		orderToolBar.add(new ControllerAction(Messages.getString("MainFrame.query_po"), //$NON-NLS-1$
		...
		reportToolBar.add(new ControllerAction(Messages.getString("MainFrame.store_info"), //$NON-NLS-1$
				SiteInfoController.class));
		reportToolBar.add(new ControllerAction(Messages.getString("MainFrame.store_transfer"), //$NON-NLS-1$
				TransferPlanController.class));
		reportToolBar.add(new ControllerAction(Messages.getString("MainFrame.view_transfer"), //$NON-NLS-1$
				ViewTransferController.class));
		reportToolBar.add(new ControllerAction(Messages.getString("MainFrame.manage_store"), //$NON-NLS-1$
		...
		profileToolBar.add(new ControllerAction(Messages.getString("MainFrame.book_manage"), //$NON-NLS-1$
				BookManagerController.class));
		profileToolBar.add(new ControllerAction(Messages.getString("MainFrame.book_set_manage"), //$NON-NLS-1$
		...
		libraryToolBar.add(new ControllerAction(Messages.getString("MainFrame.borrow_book"), //$NON-NLS-1$
				BorrowBookController.class));
		libraryToolBar.add(new ControllerAction(Messages.getString("MainFrame.return_book"), //$NON-NLS-1$
				ReturnBookController.class));
		libraryToolBar.add(new ControllerAction(Messages.getString("MainFrame.view_library"), //$NON-NLS-1$
		...
		importToolBar.add(new ControllerAction(Messages.getString("MainFrame.import_taobao_order"), //$NON-NLS-1$
		...
		printToolBar.add(new ControllerAction(Messages.getString("MainFrame.print_express"), //$NON-NLS-1$
